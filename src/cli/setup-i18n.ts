...
const ZH: SetupMessages = {
  ...
  step3Title: '授权身份',
  step3Desc: 'OAuth 授权让你可以访问已有的多维表格，并将你的身份（open_id 和 union_id）记录在配置中',
  step3Already: '已授权为',
...
const EN: SetupMessages = {
  ...
  step3Desc: 'OAuth login gives you access to your existing Bitables and records your identity (open_id and union_id) in the profile',
...
const JA: SetupMessages = {
  ...
  step3Title: 'ID を認証',
  step3Desc: 'OAuth ログインにより既存の Bitable にアクセスし、あなたの ID（open_id と union_id）をプロファイルに記録します',
  step3Already: '認証済み',
